...
notes to Rachel: need to do flask 16 manually -- exclude batch 45. Should average from 9:43 - 9:46 
the batches I've excluded are the re-measurements

Ready to do averages, then diff them and plot
