...
saveRDS(tbl, paste("data/TobleroneData", currentdate,".RDS"))

tbl <- readRDS("data/TobleroneData 2021-05-10 .RDS") #manually change this file to be the most recent version
```
